...
RoboBall is a step-by-step tutorial project that guides you through creating a physics-based bouncing ball that evolves from a simple static object to an autonomous agent capable of:
...
### [Tutorial 10: AI and Goal-Seeking](Doc/roboball_tutorial_10.md)
...
- **Tutorial Review**: Double-checked for consistency and spelling by Claude Sonnet 4.5
